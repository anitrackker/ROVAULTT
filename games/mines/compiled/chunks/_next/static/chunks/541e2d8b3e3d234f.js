(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document?document.currentScript: void 0, 572329, e => {
  ...
  "use strict"; var l = e.i(478902), a = e.i(944967), t = e.i(572329), s = e.i(187742); let i = {
    ...
    className: e, children: s, ...i
  }) {
    return(0, l.jsx)("div", {
      className: (0, a.default)(t.default.gameLayout, e), ...i, children: s
    })
  }
  u.Column = function( {
    type: e, className: u, children: m, customMobileOrder: n = "initial", mines: d = !1, ...r
  }) {
    let o = (0, s.default)(); return(0, l.jsx)("div", {
      className: (0, a.default)(t.default.gameLayoutColumn, i[e], u), style: {
  ...
  "use strict"; var l, a, t, s = e.i(478902), i = e.i(356535), u = e.i(944967); e.i(802398); var m = e.i(565252), n = e.i(14330); e.s(["capitalize", () => n.default], 219997); var n = n, d = e.i(806777), r = e.i(389959); function o() {
  ...
  }; var y = e.i(907153), v = e.i(187742), x = e.i(102205); e.s(["default", 0, ( {
    className: e, gameName: l, infoName: a, lastGame: t, showInfo: r = !0, showHistory: o = !0, labels: _ = [], playSound: g, setPlaySound: C
  }) => {
    let b = (0, m.useDispatch)(), I = (0, v.default)(), L = (0, m.useSelector)(e => e.auth.isAuthenticated), j = I.width>992 && I.width <= 1400 || I.width <= 768; return(0, s.jsxs)(s.Fragment, {
      children: [0 !== _.length && (0, s.jsx)("div", {
        className: (0, u.default)(x.default.gameInfoHeaderLeft, e), children: _.map(e => (0, s.jsx)(y.default, {
          disabled: !0, variant: "betOptionCompact", children: e.value
        }))
      }), (0, s.jsxs)("div", {
        className: (0, u.default)(x.default.gameInfoHeader, e), children: [void 0 !== g && C && (0, s.jsx)(y.default, {
          onClick: () => C(!g), variant: "betOptionCompact", children: g?(0, s.jsx)(h, {
            style: {
              width: 16, height: 16
            }
          }): (0, s.jsx)(p, {
          ...
          onClick: () => b( {
            type: i.SHOW_INFO_MODAL, payload: (0, n.default)(a || l)
          }), variant: "betOptionCompact", children: (0, s.jsx)(d.default, {
            style: {
              height: ".75em"
            }
          })
          ...
          onClick: () => b( {
            type: i.SHOW_PROVABLY, payload: {
              ...t, gameName: l
            }
          }), variant: "betOptionCompact", children: j?(0, s.jsx)(c, {

          }): "Fairness"
        }), o && L && (0, s.jsx)(y.default, {
          onClick: () => b( {
            type: i.SHOW_HISTORY_MODAL, payload: {
              gameType: l
            }
          }), variant: "betOptionCompact", children: j?(0, s.jsx)(f.default, {
            style: {
              transform: "scale(0.8)"
            }
          }): "History"
  ...
  "use strict"; let l = e.i(659319).default; e.s(["default", 0, l])
}, 329271, e => {
  "use strict"; var l = e.i(478902), a = e.i(389959); e.i(802398); var t = e.i(565252), s = e.i(569332), i = e.i(494809), u = e.i(770381); let m = e => "ROCOINS" === e?"/icons/rbx-currency.svg": "/currency-icon.svg"; e.s(["default", 0, ( {
    className: e, value: n, onChange: d, min: r, max: o, defaultValue: c, currencyOverride: f, ..._
  }) => {
    (0, t.useSelector)(e => e.auth.user); let h = (0, t.useSelector)(e => e.auth.wallet), g = (0, t.useSelector)(e => e.auth.currentCurrency) || "FLIPCOINS", p = f || g, y = (0, a.useMemo)(() => Math.floor((0, u.getWalletBalance)(h, p)), [h, p]), v = r || .001, x = o || y, C = e => {
      let l = "string" == typeof n?parseFloat(n): n; if(!l || isNaN(l))return v; let a = Math.min(x, y || 1/0); switch(e) {
        case"1/2": return Math.max(Math.floor(l/2), v); case"2x": return Math.min(2*l, a); case"max": return Math.min(Math.max(y, 0), x); default: return l
      }
    }, b = (0, a.useCallback)(() => {
      void 0 !== c && `${n}` == `${c}` && d("")
    }, [c, n]), I = (0, a.useCallback)(() => {
      void 0 !== c && "" === n && d(c)
    }, [c, n]); return(0, l.jsx)(s.default, {
      label: "Bet amount", variant: "secondary", toggleButtonsOnFocus: !0, className: e, isBet: !0, patterns: [ {
        label: "1/2", onClick: () => n && d(C("1/2"))
      }, {
        label: "2x", onClick: () => n && d(C("2x"))
      }, ...y?[ {
        label: "Max", onClick: () => d(C("max"))
      }]: []], children: (0, l.jsx)(i.default, {
        value: n, onChange: d, onFocus: b, onBlur: I, pauseBlurValidation: void 0 !== c && "" === n, min: r, max: Math.min(Math.max(y, 0), x), step: 10, hasCurrencyIcon: !0, currencyIconUrl: m(p), disableWheel: !0, ..._
      })
    })
  }, "getCurrencyIconUrl", 0, m])
}, 806777, e => {
  ...
  "use strict"; var l = e.i(478902), a = e.i(944967), t = e.i(372045), s = e.i(907153), i = e.i(807899); let u = {
    primary: i.default.formFieldPrimary, secondary: i.default.formFieldSecondary
  }; e.s(["default", 0, ( {
    className: e, isBet: m, label: n, variant: d = "primary", icon: r, patterns: o, toggleButtonsOnFocus: c, children: f
  }) => (0, l.jsxs)("div", {
    className: (0, a.default)(i.default.formField, u[d], e), children: [(0, l.jsx)(t.default, {
      element: "p", textType: "labelsRegular", children: n
    }), (0, l.jsxs)("div", {
      className: (0, a.default)("customInputInner", i.default.formFieldInner), children: [f, (0, l.jsx)("div", {
        className: (0, a.default)("customInputInnerButtons", i.default.formFieldInnerButtons, c && i.default.formFieldInnerButtonsToggleFocus), style: m? {
          right: "16px"
        }
        : {

        }, children: o?o.map((e, a) => (0, l.jsx)(s.default, {
          variant: "inputButton", onClick: e.onClick, className: i.default.innerButton, children: e.label
        }, a)): (0, l.jsx)("div", {
          className: (0, a.default)(i.default.inputIcon), children: r
        })
      })]
    })]
  })])
  ...
  "use strict"; var l = e.i(478902), a = e.i(75730); e.s(["default", 0, ( {
    value: e, onChange: t, precision: s = 2, disableWheel: i = !1, pauseBlurValidation: u, onBlur: m = () => {

    }, ...n
  }) => (0, l.jsx)(a.default, {
    type: "number", value: 0 === e?"0": e ?? "", ...n, onChange: e => {
      ...
      if(m(e), u)return; let l = parseFloat(Number(e.currentTarget.value).toFixed(s)); if(e.currentTarget.min) {
  ...
  "use strict"; var l = e.i(478902), a = e.i(944967), t = e.i(97949), s = e.i(907153); e.s(["default", 0, ( {
    className: e, showAuto: i = !1, isAuto: u = !1, setIsAuto: m
  }) => (0, l.jsx)(t.default, {
    display: "flex", gap: "1em", justifyContent: "space-between", className: e, width: "100%", children: (0, l.jsxs)(t.default, {
      display: "flex", justifyContent: "space-between", className: (0, a.default)("gameBetTabs"), children: [(0, l.jsx)(s.default, {
        variant: "tab", isActive: !u, onClick: () => m && m(!1), children: "Manual"
      }), i && (0, l.jsx)(s.default, {
        variant: "tab", isActive: u, onClick: () => m && m(!0), children: "Auto"
      })]
    })
  })])
}, 278878, e => {
  ...
  "use strict"; var l = e.i(478902), a = e.i(356535), t = e.i(944967), s = e.i(389959); e.i(802398); var i = e.i(565252), u = e.i(278878), m = e.i(187742); let n = s.default.memo(function( {
    historyValues: e, forSlide: s
  }) {
    let n = (0, m.default)(), d = (0, i.useDispatch)(), r = e => e.crashPoint?e.crashPoint: e.multiplier?e.multiplier/100: null; return e?.length?(0, l.jsx)("div", {
      className: (0, t.default)(s && u.default.slideGameLatest, "gameLatest gameLatestHorizontal", !s && "lastestHistory"), children: (s?e.slice(0, 7): n.width<768?e.slice(-6): e.slice(-7)).map((e, s) => {
        let i, u; return(0, l.jsx)("div", {
          onClick: () => d( {
            ...
            cursor: "pointer"
          }, className: (0, t.default)(`gameLatestItem ${(e=>{let l=r(e),a=e.winningColor;if("purple"===a)return"gameLatestItemPurple";if("red"===a)return"gameLatestItemRed";if("yellow"===a)return"gameLatestItemYellow";if(null!==l){if(l>2&&l<7)return"gameLatestItemYellow";if(l>=7)return"gameLatestItemBlue"}return"gameLatestItemNeutral"})(e)}`), children: null !== (i = r(e))?i: "purple" === (u = e.winningColor)?"2X": "yellow" === u?"14X": "red" === u?"2x": void 0
  ...
  "use strict"; e.s(["BET_STATES", 0, {
    Playing: 1, CashedOut: 2
  }, "GAME_STATES", 0, {
    NotStarted: 1, Starting: 2, InProgress: 3, Over: 4, Blocking: 5, Refunded: 6
  }])
}, 915468, e => {
  ...
  e.v(l => Promise.all(["static/chunks/4cd4aba53a27887a.js"].map(l => e.l(l))).then(() => l(402698)))
}]);